      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
		   ...
		   <li class="nav-item">
            <a class="nav-link active" href="./">Printers<span class="sr-only">(current)</a>
          </li>
		   <li class="nav-item">
...
<main role="main" class="container">
  <center><div class="jumbotron">
       <h1>Printer List</h1>
       <div class="form">
<p><a href="insert.php">Insert New Printer</a></p>
<table width="100%" border="1" style="border-collapse:collapse;">
<thead>
<tr>
<th><center><strong>Number</strong></th>
<th><center><strong>Printer Name</strong></th>
<th><center><strong>X-length(mm)</strong></th>
<th><center><strong>Y-length(mm)</strong></th>
<th><center><strong>Z-Height(mm)</strong></th>
...
$count=1;
$sel_query="Select * from `printers` where username='".$username."'";
$result = mysqli_query($con,$sel_query);
while($row = mysqli_fetch_assoc($result)) { ?>
<tr><td align="center"><?php echo $count; ?></td>
<td align="center"><?php echo $row["name"]; ?></td>
<td align="center"><?php echo $row["xlength"]; ?></td>
<td align="center"><?php echo $row["ylength"]; ?></td>
<td align="center"><?php echo $row["zheight"]; ?></td>
