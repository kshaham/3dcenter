    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="materials.php">Materials List<span class="sr-only">(current)</span></a>
          </li>
		   <li class="nav-item">
...
<th><center><strong>Material Name</strong></th>
<th><center><strong>Quantity</strong></th>
<th><center><strong>Price (USD)</strong></th>
...
$count=1;
$sel_query="Select * from `materials` where username='".$username."'";
